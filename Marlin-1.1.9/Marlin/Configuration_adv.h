 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD 5*60       // Seconds
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD 5*60    // Seconds
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     140  // (mm/s) Unload filament feedrate. This can be pretty fast.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   140  // (mm/s) Load filament feedrate. This can be pretty fast.
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL     20  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH     645  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
